...
<body class="antialiased bg-gray-50 dark:bg-slate-800/50 text-gray-900 dark:text-slate-100 overflow-x-hidden selection:bg-orange-500 selection:text-white">
    ...
    <nav class="absolute w-full z-50 top-0 py-6 px-6 lg:px-12 flex justify-between items-center">
        ...
        <div>
            @if (Route::has('login'))
                ...
                @else
                    <a href="{{ route('login') }}" class="font-semibold px-5 py-2.5 rounded-full bg-white dark:bg-slate-800/20 hover:bg-white dark:bg-slate-800/30 backdrop-blur-md border border-white/30 text-white transition-all shadow-lg hover:shadow-xl">Staff Login</a>
                @endauth
            @endif
        </div>
    </nav>
        ...
        <div class="relative z-10 w-full max-w-7xl px-6 lg:px-12 flex flex-col lg:flex-row items-center gap-12">
            ...
            <div class="flex-1 text-center lg:text-left pt-10 lg:pt-0">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                    ...
                    <a href="#features" class="w-full sm:w-auto px-8 py-4 bg-white dark:bg-slate-800/10 hover:bg-white dark:bg-slate-800/20 border border-white/20 text-white font-bold rounded-2xl backdrop-blur-md transition-all duration-300 text-lg flex items-center justify-center">
                        View Features
                    </a>
                </div>
            </div>
            ...
            <div class="flex-1 w-full max-w-lg lg:max-w-none relative group hidden md:block">
                ...
                <div class="relative bg-white dark:bg-slate-800/10 backdrop-blur-xl border border-white/20 p-4 rounded-[3rem] shadow-2xl transform rotate-3 group-hover:rotate-0 transition-transform duration-500">
                    <!-- Mockup of the Order Page -->
                    <div class="bg-gray-50 dark:bg-slate-800/50 rounded-[2.5rem] overflow-hidden aspect-[4/3] flex flex-col relative shadow-inner">
                        <div class="bg-white dark:bg-slate-800 px-6 py-4 flex justify-between items-center shadow-sm z-10">
                            <div class="font-bold text-lg text-gray-800 dark:text-slate-200">Our Menu</div>
                        ...
                        <div class="p-6 grid grid-cols-2 gap-4">
                            <!-- Mock Menu Cards -->
                            <div class="bg-white dark:bg-slate-800 rounded-2xl p-3 shadow-sm border border-gray-100 dark:border-slate-700/50">
                            ...
                            <div class="bg-white dark:bg-slate-800 rounded-2xl p-3 shadow-sm border border-gray-100 dark:border-slate-700/50 opacity-50">
    ...
    <!-- Features Section -->
    <div id="features" class="py-24 bg-white dark:bg-slate-800 relative">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl font-extrabold text-gray-900 dark:text-slate-100 sm:text-4xl">Modern Dining Experience</h2>
                <p class="mt-4 text-lg text-gray-500 dark:text-slate-400">Everything you need for a seamless and enjoyable restaurant visit.</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                <div class="bg-gray-50 dark:bg-slate-800/50 rounded-3xl p-8 hover:-translate-y-2 transition-transform duration-300 border border-gray-100 dark:border-slate-700/50">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-slate-100 mb-3">Digital Menu</h3>
                    <p class="text-gray-600 dark:text-slate-400">Scan the QR code on your table to instantly view our vibrant, up-to-date catalog of delicious meals.</p>
                </div>
                ...
                <div class="bg-gray-50 dark:bg-slate-800/50 rounded-3xl p-8 hover:-translate-y-2 transition-transform duration-300 border border-gray-100 dark:border-slate-700/50">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-slate-100 mb-3">Instant Orders</h3>
                    <p class="text-gray-600 dark:text-slate-400">Place your order directly from your smartphone. It goes straight to the kitchen display in real-time.</p>
                </div>
                ...
                <div class="bg-gray-50 dark:bg-slate-800/50 rounded-3xl p-8 hover:-translate-y-2 transition-transform duration-300 border border-gray-100 dark:border-slate-700/50">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-slate-100 mb-3">Easy Checkout</h3>
                    <p class="text-gray-600 dark:text-slate-400">Enjoy your meal and head to the cashier when ready. We support Cash, QRIS, and Card payments seamlessly.</p>
                </div>
            </div>
        </div>
    </div>
