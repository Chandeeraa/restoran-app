...
<head>
    ...
    <title>Kesalahan Server - YON RESTO</title>
...
<body class="bg-brand-cream font-sans min-h-screen flex items-center justify-center p-6 text-gray-800">
    <div class="max-w-md w-full bg-white rounded-3xl p-8 shadow-xl shadow-brand-yellow/10 text-center border border-gray-100 relative overflow-hidden">
        <div class="absolute top-0 left-0 right-0 h-2 bg-gradient-to-r from-red-600 via-brand-orange to-brand-green"></div>
        <span class="text-8xl block mb-6 animate-pulse">🔥</span>
        <h1 class="text-6xl font-black text-brand-orange tracking-tight mb-2">500</h1>
        <h2 class="text-xl font-bold text-gray-900 mb-4">Waduh! Ada Masalah di Dapur Kami</h2>
        <p class="text-gray-500 text-sm leading-relaxed mb-8">Maaf, terjadi kesalahan internal di server kami. Koki kami sedang memperbaikinya secepat mungkin.</p>
