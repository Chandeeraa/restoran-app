...
$classes = ($active ?? false)
            ...
            : 'block w-full ps-3 pe-4 py-2 border-l-4 border-transparent text-start text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 dark:bg-slate-800/50 hover:border-gray-300 focus:outline-none focus:text-gray-800 focus:bg-gray-50 dark:bg-slate-800/50 focus:border-gray-300 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300 transition duration-150 ease-in-out';
@endphp
