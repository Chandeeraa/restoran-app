    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-3xl shadow-lg overflow-hidden relative">
                <div class="absolute top-0 right-0 -mt-4 -mr-4 w-32 h-32 bg-white dark:bg-slate-800 opacity-10 rounded-full blur-2xl"></div>
                <div class="absolute bottom-0 left-0 -mb-4 -ml-4 w-24 h-24 bg-white dark:bg-slate-800 opacity-10 rounded-full blur-xl"></div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <!-- Stat 1 -->
                <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700/50 p-6 flex items-center space-x-4 transition-transform hover:-translate-y-1 duration-300">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <a href="{{ route('cashier.pos') }}" class="group block bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700/50 p-6 hover:shadow-md hover:border-blue-200 transition-all">
                    ...
                    <h4 class="text-lg font-bold text-gray-900 dark:text-slate-100 mb-1">Cashier POS</h4>
                    <p class="text-sm text-gray-500 dark:text-slate-400">Process payments and print receipts.</p>
                </a>

                <a href="{{ route('kitchen.kds') }}" class="group block bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700/50 p-6 hover:shadow-md hover:border-indigo-200 transition-all">
                    <div class="flex items-center justify-between mb-4">
                ...
                <a href="{{ route('admin.menus') }}" class="group block bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700/50 p-6 hover:shadow-md hover:border-orange-200 transition-all">
                    <div class="flex items-center justify-between mb-4">
