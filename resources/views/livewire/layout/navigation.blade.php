            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(auth()->user()->role === 'admin')
                        ...
                        <x-nav-link :href="route('kitchen.kds')" :active="request()->routeIs('kitchen.kds')" wire:navigate>
                            Kitchen (KDS)
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(auth()->user()->role === 'admin')
                ...
                <x-responsive-nav-link :href="route('kitchen.kds')" :active="request()->routeIs('kitchen.kds')" wire:navigate>
                    Kitchen (KDS)
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('cashier.pos')" :active="request()->routeIs('cashier.pos')" wire:navigate>
                    Cashier POS
                </x-responsive-nav-link>
            @endif
        </div>
